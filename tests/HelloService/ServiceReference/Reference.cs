...
namespace ServiceReference
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://learnwebservices.com/services/hello", ConfigurationName="ServiceReference.HelloEndpoint")]
    public interface HelloEndpoint
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceReference.SayHelloResponse> SayHelloAsync(ServiceReference.SayHello request);
    }
    ...
    public partial class SayHello
    {
        ...
        public ServiceReference.helloRequest HelloRequest;
        
        public SayHello()
        {
        }
        
        public SayHello(ServiceReference.helloRequest HelloRequest)
        {
    ...
    public partial class SayHelloResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://learnwebservices.com/services/hello", Order=0)]
        public ServiceReference.helloResponse HelloResponse;
        
        public SayHelloResponse()
        {
        }
        
        public SayHelloResponse(ServiceReference.helloResponse HelloResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public interface HelloEndpointChannel : ServiceReference.HelloEndpoint, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public partial class HelloEndpointClient : System.ServiceModel.ClientBase<ServiceReference.HelloEndpoint>, ServiceReference.HelloEndpoint
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceReference.SayHelloResponse> ServiceReference.HelloEndpoint.SayHelloAsync(ServiceReference.SayHello request)
        {
            return base.Channel.SayHelloAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference.SayHelloResponse> SayHelloAsync(ServiceReference.helloRequest HelloRequest)
        {
            ServiceReference.SayHello inValue = new ServiceReference.SayHello();
            inValue.HelloRequest = HelloRequest;
            return ((ServiceReference.HelloEndpoint)(this)).SayHelloAsync(inValue);
        }
